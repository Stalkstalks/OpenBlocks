...
public class BlockTankRenderer implements IBlockRenderer<BlockTank> {
    ...
    private static void render(Tessellator tes, INeighbourMap connections, double x, double y, double z) {
        if (shouldRenderEdgeT(connections, DIR_SOUTH, DIR_DOWN))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 0, z - H + 1, x + H + 1, y + H + 0, z + H + 1);
        if (shouldRenderEdgeT(connections, DIR_NORTH, DIR_DOWN))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 0, z - H + 0, x + H + 1, y + H + 0, z + H + 0);
        if (shouldRenderEdgeB(connections, DIR_SOUTH, DIR_UP))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 1, z - H + 1, x + H + 1, y + H + 1, z + H + 1);
        if (shouldRenderEdgeB(connections, DIR_NORTH, DIR_UP))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 1, z - H + 0, x + H + 1, y + H + 1, z + H + 0);

        if (shouldRenderEdgeT(connections, DIR_EAST, DIR_NORTH))
            RenderUtils.renderCube(tes, x - H + 1, y - H + 0, z - H + 0, x + H + 1, y + H + 1, z + H + 0);
        if (shouldRenderEdgeT(connections, DIR_WEST, DIR_NORTH))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 0, z - H + 0, x + H + 0, y + H + 1, z + H + 0);
        if (shouldRenderEdgeB(connections, DIR_EAST, DIR_SOUTH))
            RenderUtils.renderCube(tes, x - H + 1, y - H + 0, z - H + 1, x + H + 1, y + H + 1, z + H + 1);
        if (shouldRenderEdgeB(connections, DIR_WEST, DIR_SOUTH))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 0, z - H + 1, x + H + 0, y + H + 1, z + H + 1);

        if (shouldRenderEdgeT(connections, DIR_EAST, DIR_DOWN))
            RenderUtils.renderCube(tes, x - H + 1, y - H + 0, z - H + 0, x + H + 1, y + H + 0, z + H + 1);
        if (shouldRenderEdgeT(connections, DIR_WEST, DIR_DOWN))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 0, z - H + 0, x + H + 0, y + H + 0, z + H + 1);
        if (shouldRenderEdgeB(connections, DIR_EAST, DIR_UP))
            RenderUtils.renderCube(tes, x - H + 1, y - H + 1, z - H + 0, x + H + 1, y + H + 1, z + H + 1);
        if (shouldRenderEdgeB(connections, DIR_WEST, DIR_UP))
            RenderUtils.renderCube(tes, x - H + 0, y - H + 1, z - H + 0, x + H + 0, y + H + 1, z + H + 1);
    }
    ...
    @Override
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, BlockTank block, int modelId,
        ...
        INeighbourMap connections = (te instanceof TileEntityTank) ? ((TileEntityTank) te).getRenderNeigbourMap()
