...
public class ModelVacuumHopper extends ModelBase {
    ...
    private void renderValve(IReadableBitMap<ForgeDirection> itemOutputs, IReadableBitMap<ForgeDirection> xpOutputs,
            ForgeDirection direction, float rotX, float rotZ, float f5) {
