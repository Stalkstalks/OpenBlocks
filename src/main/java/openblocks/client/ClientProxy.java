...
public class ClientProxy implements IOpenBlocksProxy {
    ...
    private static final ResourceLocation RADIO_VILLAGER_TEXTURE = new ResourceLocation(
            "openblocks",
            "textures/models/king-ish.png");
    ...
    public void registerRenderInformation() {

        {
            ...
            final BlockRenderingHandler blockRenderingHandler = new BlockRenderingHandler(
                    OpenBlocks.renderIdFull,
                    true);
            ...
            {
                final IBlockRenderer<BlockGuide> guideBlockRenderer = RotatedBlockRenderer
                        .wrap(new BlockGuideRenderer());
        ...
        ClientRegistry
                .bindTileEntitySpecialRenderer(TileEntityBuilderGuide.class, new TileEntityBuilderGuideRenderer());
        ...
        ClientRegistry
                .bindTileEntitySpecialRenderer(TileEntityVacuumHopper.class, new TileEntityVacuumHopperRenderer());
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityVillageHighlighter.class,
                new TileEntityVillageHighlighterRenderer());
        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityAutoAnvil.class, new TileEntityAutoAnvilRenderer());
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityAutoEnchantmentTable.class,
                new TileEntityAutoEnchantmentTableRenderer());
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityDonationStation.class,
                new TileEntityDonationStationRenderer());
        ...
        if (OpenBlocks.Blocks.tank != null) MinecraftForgeClient
                .registerItemRenderer(Item.getItemFromBlock(OpenBlocks.Blocks.tank), new ItemRendererTank());
        ...
        if (OpenBlocks.Blocks.paintCan != null) {
            MinecraftForgeClient.registerItemRenderer(
                    Item.getItemFromBlock(OpenBlocks.Blocks.paintCan),
                    new ItemRendererPaintCan());
        }
        ...
        if (OpenBlocks.Items.cartographer != null) {
            RenderingRegistry
                    .registerEntityRenderingHandler(EntityCartographer.class, new EntityCartographerRenderer());
            EntitySelectionHandler
                    .registerRenderer(EntityCartographer.class, new EntityCartographerRenderer.Selection());
        }

        if (OpenBlocks.Blocks.trophy != null) {
            MinecraftForgeClient
                    .registerItemRenderer(Item.getItemFromBlock(OpenBlocks.Blocks.trophy), new ItemRendererTrophy());
        }
