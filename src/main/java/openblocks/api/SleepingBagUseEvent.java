...
/**
 * Event triggered before player uses sleeping bag. Use {@link Event#setResult(Result)} to override:
 * {@link Event.Result.ALLOW} to allow even if original algorithm forbids it, {@link Event.Result.DENY} to block
 * normally allowed action.
 */
@HasResult
