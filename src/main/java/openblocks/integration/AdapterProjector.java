...
public class AdapterProjector implements IPeripheralAdapter {
    ...
    public void setMapInfo(TileEntityProjector projector,
            @Arg(
                    name = "properties",
                    description = "Map of properties",
                    type = ArgType.TABLE) Map<String, Object> args) {
        HeightMapData data = projector.getMap();
    ...
    @Asynchronous
    @ScriptCallable(
            returnTypes = { ReturnType.NUMBER, ReturnType.NUMBER },
            description = "Get height and color of point on map")
    ...
    public void setPoint(TileEntityProjector projector, @Arg(name = "row", description = "Map row (0..63)") int row,
            @Arg(name = "column", description = "Map column (0..63)") int column,
            @Arg(name = "layer", description = "Map layer") int layer,
