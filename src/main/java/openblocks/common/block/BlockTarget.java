...
public class BlockTarget extends OpenBlock {
    ...
    public void onTargetHit(World world, int x, int y, int z, Vec3 entityPosition) {
        ...
        /**
         * onEntityCollidedWithBlock is called twice when the arrow is hit The first is from the raytracing, which is
         * predictive and inaccurate The second is from the bounding box collision. We only care about the second one
         */
