...
public class ItemPaintBrush extends Item {
    ...
    private static boolean tryRecolorBlock(World world, int x, int y, int z, int rgb, ForgeDirection... sides) {
        ...
        if (block instanceof IPaintableBlock) {
            ...
            for (ForgeDirection dir : sides) result |= canvas.recolourBlockRGB(world, x, y, z, dir, rgb);
        ...
        if (nearest != null) {
            ...
            boolean result = false;
            for (ForgeDirection dir : sides) result |= block.recolourBlock(world, x, y, z, dir, vanillaColorId);
