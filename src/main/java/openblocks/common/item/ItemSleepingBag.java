...
public class ItemSleepingBag extends ItemArmor {
    ...
    private static final FieldAccess<Boolean> IS_SLEEPING = FieldAccess
            .create(EntityPlayer.class, "sleeping", "field_71083_bS");

    private static final FieldAccess<Integer> SLEEPING_TIMER = FieldAccess
            .create(EntityPlayer.class, "sleepTimer", "field_71076_b");
