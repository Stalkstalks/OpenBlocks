...
public class ItemCartographer extends Item {
    ...
    public void registerIcons(IIconRegister register) {
        for (AssistantType type : AssistantType.VALUES) type.icon = register.registerIcon(type.iconName);
    }
    ...
    public void getSubItems(Item item, CreativeTabs tab, List result) {
        for (AssistantType type : AssistantType.VALUES) result.add(new ItemStack(this, 1, type.ordinal()));
    }
