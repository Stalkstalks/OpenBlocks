...
public class EntityItemProjectile extends EntityItem {
    ...
    public EntityItemProjectile(World par1World, double par2, double par4, double par6) {
        super(par1World, par2, par4, par6);
    }

    public EntityItemProjectile(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack) {
