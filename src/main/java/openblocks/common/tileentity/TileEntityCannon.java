...
public class TileEntityCannon extends SyncedTileEntity implements IPointable, ISurfaceAttachment, ITriggerable {
    ...
    public void trigger() {
        ...
        for (int i = 0; i < 20; i++) {
            worldObj.spawnParticle(
                    (i < 4 ? "large" : "") + "smoke",
                    x + xCoord + 0.3 + (worldObj.rand.nextDouble() * 0.4),
                    yCoord + 0.7,
                    z + zCoord + 0.3 + (worldObj.rand.nextDouble() * 0.4),
                    0.0D,
                    0.0D,
                    0.0D);
        }
    ...
    public void setTarget(int x, int y, int z) {
        ...
        final float lobScale = (float) Math.min(
    ...
    static class TileEntityCannonLogic {
        ...
        /*
         * Hello, If you think you can improve the code below to work better, all power to you! But please, if you give
         * up and revert your changes. Increment the counter below as an increasing warning to the next sorry soul that
         * thinks they can make this work better. Regards -NC
         */
         ...
         */
        private static final Vec3 PHYS_GRAVITY_VECTOR_SQUARE_PARTIAL = Vec3
                .createVectorHelper(0, PHYS_PARTIAL_TIME_SQUARE * -PHYS_PARTIAL_WORLD_GRAVITY, 0);
