...
public class TileEntityBearTrap extends SyncedTileEntity
        implements IActivateAwareTile, ISurfaceAttachment, INeighbourAwareTile, IAddAwareTile {
    ...
    private Entity getEntity() {
        ...
        for (Entity entity : entityList) if (uuid.equals(entity.getUniqueID())) {
            cachedEntity = entity;
            return entity;
        }
