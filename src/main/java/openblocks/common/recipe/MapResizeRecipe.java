...
public class MapResizeRecipe extends ShapedOreRecipe {
    ...
    public MapResizeRecipe() {
        super(
                Items.emptyMap.createMap(1),
                " e ",
                "eme",
                " e ",
                'e',
                MetasGeneric.mapMemory.newItemStack(),
                'm',
                Items.emptyMap.createMap(0));
    }

    @Override
    public boolean matches(InventoryCrafting inventory, World world) {
        if (inventory.getStackInRowAndColumn(0, 0) != null || inventory.getStackInRowAndColumn(0, 2) != null
