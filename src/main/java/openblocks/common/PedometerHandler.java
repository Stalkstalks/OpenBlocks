...
public class PedometerHandler {
    ...
    public static class PedometerState implements IExtendedEntityProperties {
        ...
        public void update(Entity entity) {
            ...
            lastResult = new PedometerData(
                    startPos,
                    ticksFromStart,
                    totalDistance,
                    distanceFromStart,
                    distanceFromLastCheck,
                    timeFromLastCheck,
                    currentSpeed);
        }
    ...
    public static class PedometerData {
        ...
        private PedometerData(Vec3 startingPoint, long totalTime, double totalDistance, double straightLineDistance,
                double lastCheckDistance, long lastCheckTime, double currentSpeed) {
