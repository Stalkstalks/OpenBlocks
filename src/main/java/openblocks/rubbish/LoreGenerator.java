...
public class LoreGenerator {
    ...
    private static IGenerator createHeroGenerator() {
        ...
        IGenerator heroClass = alt(
                ...
                "visigoth",
                "nipple twister");
        IGenerator classicHeroes = capitalizeFully(
                seq(
                        heroName,
                        "the",
                        seq(
    ...
    private static IGenerator createLoreGenerator() {
        ...
        IGenerator foundation = seq(
                word(capitalizeFully(foundationFirst), "-a-", capitalizeFully(foundationSecond)),
                "foundation");
