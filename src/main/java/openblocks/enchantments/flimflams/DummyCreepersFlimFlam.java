...
public class DummyCreepersFlimFlam implements IFlimFlamAction {
    ...
    private static final FieldAccess<Integer> EXPLOSION_RADIUS = FieldAccess
            .create(EntityCreeper.class, "explosionRadius", "field_82226_g");
    private static final FieldAccess<DataWatcher> DATA_WATCHER = FieldAccess
            .create(EntityCreeper.class, "dataWatcher", "field_70180_af");
    ...
    public boolean execute(EntityPlayerMP target) {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            creeper.setPosition(
                    target.posX + 20 * (random.nextFloat() - 0.5),
